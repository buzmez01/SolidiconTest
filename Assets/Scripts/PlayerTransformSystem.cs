...
{
    public static Vector3[] linePoints = new Vector3[22];
    public static Vector3[] lineVectors = new Vector3[22];
    ...
    public static void Run(GameObject[] players)
    {
        ...
        for (int i = 0; i < players.Length; i++)
        {
            ...
            float distance = 100f;
            Vector3 pos2NonY = new Vector3(pos2.x, 0, pos2.y);
            Vector3 pos1NonY = new Vector3(pos1.x, 0, pos1.y);
            linePoints[i] = newPos;
            lineVectors[i] = pos2NonY - pos1NonY;

            Debug.DrawRay(newPos, (lineVectors[i]) * distance, Color.blue);
